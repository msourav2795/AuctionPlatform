    ...
    <jsp:include page="./menu/menu.jsp"></jsp:include>
        <div class="container">
            ...
            <table class="table table-striped" id="show">
                ...
                <tr>
                    <td>
                        <input name="name" type="text" id="id" class="form-control" value="${user.id}" readonly/>
                </td> 
                <td>
                    <input name="name" type="text" id="name" class="form-control" value="${user.name}" readonly/>
                </td> 
                <td>
                    <input name="name" type="text" id="username" class="form-control" value="${user.username}" readonly/>
                </td>
                <td>
                    <input name="name" type="text" id="status" class="form-control" value="${user.status}" readonly/>
                </td>
                <td>
                    <input name="address" type="text" id="contact" class="form-control" value="${user.contact}" readonly/>
                </td>
                <td>
                    <input name="contact" type="text" id="address" class="form-control" value="${user.address}" readonly/>
                </td>                        
            </tr>           
        ...
        <div style="width:400px;margin: auto">
            <button class="btn btn-lg btn-primary" data-toggle="modal" data-target="#myModal" onclick="editUser(${user.id})">Edit Details</button> 
